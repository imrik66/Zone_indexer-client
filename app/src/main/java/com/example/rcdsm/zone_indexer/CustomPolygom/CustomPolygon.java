package com.example.rcdsm.zone_indexer.CustomPolygom;
...
public class CustomPolygon
{
	...
	private CustomPolygon(List<Line> sides, BoundingBox boundingBox)
	{
		_sides = sides;
	...
	public static class Builder
	{
		...
		public CustomPolygon build()
		{
			...
			CustomPolygon polygon = new CustomPolygon(_sides, _boundingBox);
			return polygon;
		}
		...
		private void validate()
		{
			if (_vertexes.size() < 3)
			{
				throw new RuntimeException("CustomPolygon must have at least 3 points");
			}
		}
	}
